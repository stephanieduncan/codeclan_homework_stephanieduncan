...
Answer: If the RMSE error on the test set is lower than the training set, it is likely that the model is over-fitting. It is expected that the RMSE error is lower when predicting on the training data as it is easier to make predictions on data that is used for training.
